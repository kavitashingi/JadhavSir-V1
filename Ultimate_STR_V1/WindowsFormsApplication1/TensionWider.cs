...
{
    public partial class TensionWider : Form
    {
        ...
        void nameplate()
        {
            ...
            try
            {
                ...
                connection.Open();
                var query = "select count(*) FROM nameplate32_3 where `date` like('" + theDate + "%') and batchno='" + batchcombo.SelectedItem.ToString() + "'  ;";
        ...
        void genraterpt()
        {
            ...
            try
            {
                ...
                this.tbldata_32_t39TableAdapter.Fill(this.DataSet28.tbldata_32_t39, batchcombo.SelectedItem.ToString());
        ...
        void retrivenameplate()
        {
            ...
            try
            {
                connection = new MySqlConnection(connectionString);
                connection.Open();
                var query = "select distinct * FROM nameplate32_3 where `date` like('" + theDate + "%') and batchno='" + batchcombo.SelectedItem.ToString() + "' ;";
        ...
        {
            // TODO: This line of code loads data into the 'DataSet28.tbldata_32_t39' table. You can move, or remove it, as needed.
            //this.tbldata_32_t39TableAdapter.Fill(this.DataSet28.tbldata_32_t39);
        ...
        void getbatch()
        {
            try
            {
                ...
                try
                {
                    connection = new MySqlConnection(connectionString);
                    connection.Open();
                    var query = "select distinct (`batchno`) FROM tbldata_32_t39 where `date` like('" + theDate + "%')  ;";
        ...
        private void btnok_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "INSERT INTO nameplate32_3 (`date`,  `batchno`,`shift`, `supervisor`) VALUES('" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "','" + batchcombo.SelectedItem.ToString() + "','" + shifttxt.Text + "',' ');";
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            TensionWider_Opereation op = new TensionWider_Opereation(str, i);
                                ...
                                if (date != "" || batchno != "" || benchno != "" || intialread != "" || rlu != "" || rll != "" || rru != "" || rrl != "" || frlu != "" || frll != "" || frru != "" || frrl != "" || wirelength != "" || cross_section != "" || youngsmodulus != "" || elongation != "" || elongationkn != "" || prestress != "" || mbatch != "")
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        if (AnsCount2 == 0)// && AnsCount3 == 0)
                                        {
                                            ...
                                            strQuery2111 = "INSERT INTO tbldata_32_t39 (batchno, benchno, intialread, rlu, rll, rru, rrl, frlu, frll, frru, frrl, wirelength, cross_section, youngsmodulus, elongation, elongationkn, prestress, mbatch, `date`)  VALUES ('" + batchno.Trim() + "','" + benchno.Trim() + "','" + intialread.Trim() + "','" + rlu.Trim() + "','" + rll.Trim() + "','" + rru.Trim() + "','" + rrl.Trim() + "','" + frlu.Trim() + "','" + frll.Trim() + "','" + frru.Trim() + "','" + frrl.Trim() + "','" + wirelength.Trim() + "','" + cross_section.Trim() + "','" + youngsmodulus.Trim() + "','" + elongation.Trim() + "','" + elongationkn.Trim() + "','" + prestress.Trim() + "','" + mbatch.Trim() + "','" + date.Trim() + "');";
                                            temp = strQuery2111;
        ...
        private void tbldata_32_turnoutBindingSource_CurrentChanged(object sender, EventArgs e)
        {

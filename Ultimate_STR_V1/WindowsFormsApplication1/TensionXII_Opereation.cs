...
{
    public partial class TensionXII_Opereation : Form
    {
        ...
        public TensionXII_Opereation()
        {
            InitializeComponent();
        }

        public TensionXII_Opereation(string id, int i)
        {
            InitializeComponent();
            userid = id;
            rowId = i;
        ...
        private void Opereation_Form32_1_Load(object sender, EventArgs e)
        {
                ...
                if (HourMD <= 24 && MinMD <= 60 && SecMD <= 60)
                {
                    ...
                    else
                    {
                        ...
                        if (result == DialogResult.Yes)
                        {
                            ...
                            var query = "insert into tbldata_32 (batchno, castno, benchno, intialread, rlu, rll, rru, rrl, frlu, frll, frru, frrl, wirelength, cross_section, youngsmodulus, elongation, elongationkn, prestress, mbatch, date) values ('" + textBox1.Text.Trim() + "','" + textBox2.Text.Trim() + "','" + textBox3.Text.Trim() + "','" + textBox4.Text.Trim() + "','" + textBox5.Text.Trim() + "','" + textBox6.Text.Trim() + "','" + textBox7.Text.Trim() + "','" + textBox8.Text.Trim() + "','" + textBox9.Text.Trim() + "','" + textBox10.Text.Trim() + "','" + textBox11.Text.Trim() + "','" + textBox12.Text.Trim() + "','" + textBox13.Text.Trim() + "','" + textBox14.Text.Trim() + "','" + textBox15.Text.Trim() + "','" + textBox16.Text.Trim() + "','" + textBox17.Text.Trim() + "','" + textBox18.Text.Trim() + "','" + textBox1.Text.Trim() + "','" + AllDate + "');";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    var query = "delete from tbldata_32 where mbatch='" + update_txtBox1 + "' and  batchno='" + update_txtBox1 + "' and date = '" + datetimeMD + "';";
                    using (var command = new MySqlCommand(query, myConn))
                    {
                        using (var reader = command.ExecuteReader())
                        {

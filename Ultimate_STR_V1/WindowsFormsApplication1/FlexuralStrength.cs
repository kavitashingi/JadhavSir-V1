...
{
    public partial class FlexuralStrength : Form
    {
        ...
        void nameplate()
        {
            ...
            try
            {
                ...
                connection.Open();
                var query = "select count(*) FROM nameplate30 where `date` like('" + theDate + "%') and batchno='" + cmbBatchNo.SelectedItem.ToString() + "'  ;";
        ...
        void genraterpt()
        {
            ...
            try
            {
                ...
                parms[0] = new ReportParameter("Date", dateTimePicker_FS.Value.ToString("dd-MM-yyyy"));
                parms[1] = new ReportParameter("Batch", cmbBatchNo.SelectedItem.ToString());
                ...
                this.tbldata_30TableAdapter.Fill(this.DataSet28.tbldata_30, cmbBatchNo.SelectedItem.ToString());
        ...
        void retrivenameplate()
        {
            ...
            try
            {
                connection = new MySqlConnection(connectionString);
                connection.Open();
                var query = "select distinct * FROM nameplate30 where `date` like('" + theDate + "%') and batchno='" + cmbBatchNo.SelectedItem.ToString() + "' ;";
        ...
        private void btnok_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "INSERT INTO nameplate30 (`date`,  `batchno`,`shift`, `supervisor`) VALUES('" + dateTimePicker_FS.Value.ToString("yyyy-MM-dd") + "','" + cmbBatchNo.SelectedItem.ToString() + "','" + shifttxt.Text + "',' ');";
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            FlexuralStrength_Opereation op = new FlexuralStrength_Opereation(str, i);
            //Opereation op = new Opereation(str, i);
            op.Show();

        }

        private void Form30_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyData == key)
            {
        ...
        void gridfill()
        {
            try
            {
                ...
                batch = cmbBatchNo.SelectedItem.ToString();

                GlobalClass.adap = new MySqlDataAdapter("SELECT mbatch as `Batch No`, castdate as `Cast Date`, `sleeperno` as `sleeperno`, ageindays as `Age In Days`, `date` as `Date`, loadinkn as `Load In Kn`, strength as `Strength` FROM tbldata_30 where mbatch = '" + batch + "' ;", myConn7);
        ...
        private void rdbBatchwise_CheckedChanged(object sender, EventArgs e)
        {

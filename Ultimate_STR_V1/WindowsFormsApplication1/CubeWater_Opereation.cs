...
{
    public partial class CubeWater_Opereation : Form
    {
        ...
        public CubeWater_Opereation()
        {
            InitializeComponent();
        }

        public CubeWater_Opereation(string id, int i)
        {
            InitializeComponent();
        ...
        private void Opereation_Form29_2_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (HourMD <= 24 && MinMD <= 60 && SecMD <= 60)
                    {
                        ...
                        {
                            var query = "insert into tbldata_29_2 (batchno, cubeno, initialwt, castdate, ageindays, date, laodinkn, strength, mbatch, mix_design) values ('" + textBox1.Text.Trim() + "', '" + textBox2.Text.Trim() + "', '" + textBox3.Text.Trim() + "','" + dateTimePicker1.Value.ToString("yyyy-MM-dd hh:mm:ss") + "', '" + textBox4.Text.Trim() + "','" + AllDate + "','" + textBox5.Text.Trim() + "','" + textBox6.Text.Trim() + "','" + textBox1.Text.Trim() + "','" + cmbMixDesign.SelectedItem.ToString() + "');";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    var query = "delete from tbldata_29_2 where mbatch='" + update_txtBox1 + "' and batchno = '" + update_txtBox1 + "' and  cubeno = '" + update_txtBox2 + "' and  initialwt = '" + update_txtBox3 + "' and  `castdate`= '" + datetimeMD1 + "' and   ageindays = '" + update_txtBox4 + "' and  `date` = '" + datetimeMD2 + "' and  laodinkn= '" + update_txtBox5 + "' and strength= '" + update_txtBox6 + "';";
                    using (var command = new MySqlCommand(query, myConn))
                    {
                        using (var reader = command.ExecuteReader())
                        {

...
{
    public partial class CubeSteam_Opereation : Form
    {
        ...
        public CubeSteam_Opereation(string id, int i)
        {
            InitializeComponent();
            userid = id;
            rowId = i;
        ...
        private void Opereation_Form29_3_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmbMixDesign.SelectedIndex == -1 || textBox1.Text.Trim() == "" || textBox2.Text.Trim() == "" || dateTimePicker1.Text.Trim() == "" || dateTimePicker2.Text.Trim() == "" || textBox3.Text.Trim() == "" || textBox4.Text.Trim() == "" || textBox5.Text.Trim() == "" || textBox6.Text.Trim() == "")
                {
                ...
                else
                {
                    ...
                    if (HourMD <= 24 && MinMD <= 60 && SecMD <= 60)
                    {
                        ...
                        {
                            var query = "insert into tbldata_29_3 (batchno, cubeno, initialwt, castdate, ageinhr, date, laodinkn, strength, mbatch, mix_design) values ('" + textBox1.Text.Trim() + "', '" + textBox2.Text.Trim() + "', '" + textBox3.Text.Trim() + "','" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "', '" + textBox4.Text.Trim() + "','" + AllDate + "','" + textBox5.Text.Trim() + "','" + textBox6.Text.Trim() + "','" + textBox1.Text.Trim() + "','" + cmbMixDesign.SelectedItem.ToString() +"');";
                ...
                //GlobalClass.adap.Update(GlobalClass.dt);
                  HourMD = Convert.ToInt32(textBox19.Text);
                    ...
                    if (HourMD <= 24 && MinMD <= 60 && SecMD <= 60)
                    {
                        ...
                        if (result == DialogResult.Yes)
                        {
                            var query = "update tbldata_29_3 set mix_design='" + cmbMixDesign.SelectedItem.ToString() + "', batchno = '" + textBox1.Text.Trim() + "', cubeno = '" + textBox2.Text.Trim() + "', initialwt = '" + textBox3.Text.Trim() + "', `castdate`= '" + dateTimePicker1.Value.ToString("yyyy-MM-dd HH:mm:ss") + "', ageinhr = '" + textBox4.Text.Trim() + "', `date`= '" + AllDate + "', laodinkn= '" + textBox5.Text.Trim() + "', strength= '" + textBox6.Text.Trim() + "', mbatch = '" + textBox1.Text.Trim() + "' where mbatch='" + update_txtBox1 + "' and cubeno = '" + update_txtBox2 + "' and  initialwt = '" + update_txtBox3 + "' and  `castdate`= '" + datetimeMD1 + "' and  ageinhr = '" + update_txtBox4 + "' and  `date`= '" + datetimeMD2 + "' and  laodinkn= '" + update_txtBox5 + "' and strength= '" + update_txtBox6 + "';";
                            using (var command = new MySqlCommand(query, myConn))
                            {
                                using (var reader = command.ExecuteReader())
                                {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    var query = "delete from tbldata_29_3 where mbatch='" + update_txtBox1 + "' and batchno = '" + update_txtBox1 + "' and  cubeno = '" + update_txtBox2 + "' and  initialwt = '" + update_txtBox3 + "' and  `castdate`= '" + datetimeMD1 + "' and  ageinhr = '" + update_txtBox4 + "' and  `date`= '" + datetimeMD2 + "' and  laodinkn= '" + update_txtBox5 + "' and strength= '" + update_txtBox6 + "';";
                    using (var command = new MySqlCommand(query, myConn))
                    {
                        using (var reader = command.ExecuteReader())
                        {

...
{
    public partial class TensionXII : Form
    {
        ...
        private void Form32_1_Load(object sender, EventArgs e)
        {
        ...
        void nameplate()
        {
            ...
            try
            {
                ...
                connection.Open();
                var query = "select count(*) FROM nameplate32_1 where `date` like('" + theDate + "%') and batchno='" + batchcombo.SelectedItem.ToString() + "'  ;";
        ...
        void genraterpt()
        {
            ...
            try
            {
                ...
                //  this.tbldata_32_1TableAdapter.Fill(this.DataSet28.tbldata_28_1, batchcombo.SelectedItem.ToString());
                this.tbldata_32TableAdapter.Fill(this.DataSet28.tbldata_32, batchcombo.SelectedItem.ToString());
        ...
        void retrivenameplate()
        {
            ...
            try
            {
                connection = new MySqlConnection(connectionString);
                connection.Open();
                var query = "select distinct * FROM nameplate32_1 where `date` like('" + theDate + "%') and batchno='" + batchcombo.SelectedItem.ToString() + "' ;";
        ...
        void getbatch()
        {
            ...
            try
            {
                connection = new MySqlConnection(connectionString);
                connection.Open();
                var query = "select distinct (`batchno`) FROM tbldata_32 where `date` like('" + theDate + "%')  ;";
        ...
        private void btnok_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "INSERT INTO nameplate32_1 (`date`,  `batchno`,`shift`, `supervisor`) VALUES('" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "','" + batchcombo.SelectedItem.ToString() + "','" + shifttxt.Text + "','" + supervisertxt.Text + "');";
        ...
        private void Form32_1_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyData == key)
            {
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            TensionXII_Opereation op = new TensionXII_Opereation(str, i);
                                ...
                                if (date != "" || batchno != "" || benchno != "" || intialread != "" || rlu != "" || rll != "" || rru != "" || rrl != "" || frlu != "" || frll != "" || frru != "" || frrl != "" || wirelength != "" || cross_section != "" || youngsmodulus != "" || elongation != "" || elongationkn != "" || prestress != "" || mbatch != "")
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        if (AnsCount2 == 0)// && AnsCount3 == 0)
                                        {
                                            ...
                                            strQuery2111 = "INSERT INTO tbldata_32 (batchno, benchno, intialread, rlu, rll, rru, rrl, frlu, frll, frru, frrl, wirelength, cross_section, youngsmodulus, elongation, elongationkn, prestress, mbatch, `date`)  VALUES ('" + batchno.Trim() + "','" + benchno.Trim() + "','" + intialread.Trim() + "','" + rlu.Trim() + "','" + rll.Trim() + "','" + rru.Trim() + "','" + rrl.Trim() + "','" + frlu.Trim() + "','" + frll.Trim() + "','" + frru.Trim() + "','" + frrl.Trim() + "','" + wirelength.Trim() + "','" + cross_section.Trim() + "','" + youngsmodulus.Trim() + "','" + elongation.Trim() + "','" + elongationkn.Trim() + "','" + prestress.Trim() + "','" + mbatch.Trim() + "','" + date.Trim() + "');";
                                            temp = strQuery2111;
